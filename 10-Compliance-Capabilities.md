...
# DataFab Compliance Capabilities
...
DataFab maintains compliance with applicable regulations and industry standards.
...
| Enterprise Data Standards | Data handling and governance | Aligned |
| HIPAA | Healthcare data protection (where applicable) | Aligned |
| PCI DSS | Payment data security (where applicable) | Aligned |

**Note:** For graph-based operational intelligence including pattern detection, entity assessment workflows, and case management, see [08-Graph-Operations](./08-Graph-Operations.md).
...
| Compliance Events | 7 years | Immutable storage |
| Regulatory Filings | 7 years | Immutable storage |
| System Execution Logs | 5 years | Immutable storage |

**Note:** Domain-specific compliance logs may have extended regulatory retention requirements based on applicable standards.

---

## Data Hold and Retention Management

DataFab manages data hold and retention policies through metadata-level tagging in the Knowledge Fabric, enabling centralized policy management without modifying source system data.
...
|:-----------|:---------------|
| Hold Application | Apply data hold to specific datasets, entities, or record sets |
...
| Event-Based | Retain until event occurs | Until process closure + 3 years |
| Regulatory | Compliance-driven retention | Per industry standards |
| Sensitive | Extended retention for sensitive data | Privacy-protected materials |
...
| Sensitive Data | Extended retention, restricted access | 10+ years, data steward access only |
...
| Data Hold Applied | Dataset, records, hold reason, applier | Permanent |
| Data Hold Released | Dataset, records, release reason, approver | Permanent |
