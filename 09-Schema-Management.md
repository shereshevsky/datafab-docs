...
# DataFab Schema Management & Business Domain Discovery
...
The Schema Management system provides a unified approach to defining, discovering, and managing business domain schemas across the DataFab platform. It enables users to describe their business domain through document analysis and creates structured schemas that control data extraction, agent behavior, and integration patterns.
...
│                                                                         │
│  ┌─────────────────┐                                                    │
│  │  User Documents │  Policies, procedures, data specifications,        │
│  │  (Input)        │  data dictionaries, forms, templates, configs      │
│  └────────┬────────┘                                                    │
│           │                                                             │
│           ▼                                                             │
│  ┌─────────────────┐                                                    │
...
│  │  Extraction     │  • Entities (Organization, System, Process)        │
│  │                 │  • Attributes (name, date, value)                  │
│  │                 │  • Relationships (owns, references, related_to)    │
│  └────────┬────────┘                                                    │
│           │                                                             │
│           ▼                                                             │
│  ┌─────────────────┐                                                    │
...
| Configuration Guides | System settings, parameters | Configuration options, settings, defaults |
| Data Dictionaries | Field definitions, types | Attribute names, data types, validation rules |
| Technical Specifications | System features, integrations | Feature names, integration points, capabilities |
...
|:-----------|:------------|
| Entity Recognition | Identify business entities (Customer, Organization, Resource, etc.) |
...
| Reference | Link to another entity | Customer ID, resource reference |
...
|:-----------|:------------|:--------|
| Required | Field must have a value | Customer name is required |
...
| Reference | Valid entity reference | Customer must exist |
