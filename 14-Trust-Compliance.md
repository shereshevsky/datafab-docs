...
This document describes how DataFab-managed deployments (SaaS and Dedicated Cloud Tenant) are operated to meet customer security, regulatory, and compliance requirements. For self-hosted deployment options, see [02-Architecture](./02-Architecture.md).

---

## 1. Shared Responsibility Model

DataFab operates under a clear shared responsibility model that delineates security and compliance obligations between DataFab and the customer.

### Responsibility Matrix

| Domain | DataFab Responsibility | Customer Responsibility |
|:-------|:------------------------|:------------------------|
| **Infrastructure** | Platform hosting, patching, availability | N/A (managed by DataFab) |
| **Application Security** | Code security, vulnerability management, updates | N/A (managed by DataFab) |
...
|:---------|:--------------------|
| Security Incident Response | DataFab leads technical response; customer informed per SLA; joint post-incident review |
| Compliance Evidence | DataFab provides platform evidence; customer provides business process evidence |
| Risk Assessment | DataFab provides platform risk posture; customer assesses business risk |
| Audit Support | DataFab provides SOC 2 reports and attestations; supports customer audit requests |
...
| Encryption Keys | DataFab-managed or customer-managed keys (BYOK) |
...
DataFab's managed service operations ensure customer security, regulatory, and compliance requirements are met through:

- **Clear Responsibility Model**: Defined boundaries between DataFab and customer obligations
