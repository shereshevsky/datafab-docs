...
The DataFab API layer provides secure, programmatic access to platform capabilities. All external integrations, client applications, and inter-service communications are secured through a centralized API Gateway with comprehensive security controls.
...
│  │                      BACKEND SERVICES                              │ │
│  │  ┌───────────┐  ┌───────────┐  ┌───────────┐  ┌─────────────────┐  │ │
│  │  │ Knowledge │  │  Studio   │  │  Graph    │  │  Schema         │  │ │
│  │  │  Fabric   │  │  API      │  │  RAG API  │  │  API            │  │ │
│  │  └───────────┘  └───────────┘  └───────────┘  └─────────────────┘  │ │
│  └────────────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────────────┘
```
...
DataFab supports multiple authentication methods to accommodate different integration patterns.
...
DataFab uses URL-based versioning with clear deprecation policies.
